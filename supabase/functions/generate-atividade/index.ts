...
Dado um tema, gere uma atividade completa organizada em DUAS PÁGINAS:
- PÁGINA 1: Título + texto explicativo (SOMENTE texto, SEM questões)
- PÁGINA 2: Separador + questões (SOMENTE questões)
